...
| `models.py`, `fetch.py`, `match.py` | Skeleton — interfaces sketched, no logic |
| `sources/`, `store.py`, `health.py`, `report.py`, `cli.py` | Not started |
| Markdown → `companies.yaml` migration | Not started |
| Curated target data (82 companies, 56 slugs hand-verified) | **Complete** — carries over unchanged |
